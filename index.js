...
(function () {
    ...
    Trex.prototype = {
        ...
        /**
         * Draw the hamster to a particular position.
         * @param {number} x
         * @param {number} y
         */
        draw: function (x, y) {
            // Get the hamster image
            var hamsterImg = document.getElementById('hamster-sprite');

            // Draw the hamster image instead of T-Rex sprite
            var drawWidth = this.config.WIDTH;
            var drawHeight = this.config.HEIGHT;

            // If ducking, make it slightly squished (funny effect)
            if (this.ducking && this.status != Trex.status.CRASHED) {
                drawHeight = this.config.HEIGHT_DUCK;
                drawWidth = this.config.WIDTH_DUCK;
            }

            // Draw the hamster
            this.canvasCtx.drawImage(hamsterImg,
                this.xPos, this.yPos,
